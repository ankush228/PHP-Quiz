					...
					<div style="background-color: #EEEEEE;float: right;width: 310px;padding-right: 20px;margin-right: 500px; border-radius:50px; border-color: black; border-style: solid;">
						...
						<table border="0" align="center" width = "200" style="font-family:georgia;font-size:15px;">
							...
							<td align="right" width="120" style="padding-right:5px">Email:</td>
								<td align="left" style="color:red;">
									<input style = "height:25px; padding-left:10px;border-radius:5px;" size = "25" type="email" name="email" placeholder="Email" required = "true"/>								</td>		
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left" style="color:red;">
									<input style = "height:25px; padding-left:10px;border-radius:5px;" size = "25" type="password" name="password2" placeholder="Confirm Password" required = "true"/>								</td>
							</tr>
